export default {
  ...
  whatsNewStep2Title: 'New: Screen group',
  whatsNewStep2Content: 'Provides a new scrolling experience that consists of multiple screens that will occupy the entire screen height. You can scroll the content in a scrolling panel of one screen while the widgets in the screen’s background remain. The screen background will change once the scrolling panel is scrolled through.',
  whatsNewStep3Title: 'New: Table widget(beta)',
  whatsNewStep3Content: 'Allows you to display attribute sheets from data in tabular form.',
  whatsNewStep4Title: 'Bookmark widget',
  whatsNewStep4Content: 'Adds support to initialize bookmark when the widget loads for paging style bookmark.',
  whatsNewStep5Title: 'Embed widget',
  whatsNewStep5Content: 'Add several options, such as setting the auto-fresh interval for embedded content and allow users to access embedded ArcGIS Online item shared across organizations without extra sign-in.',
  whatsNewStep6Title: 'Filter widget',
  whatsNewStep6Content: 'Adds predefined values(unique and multiple) in SQL expression builder.',
  whatsNewStep7Title: 'Map widget',
  whatsNewStep7Content: 'Adds support to change the highlight color of your selected feature.',
  whatsNewStep8Title: 'Section widget',
  whatsNewStep8Content: 'Adds support to auto play and built in navigation such as arrows and dots.',
  whatsNewStep9Title: 'Survey widget',
  whatsNewStep9Content: 'Adds support for passing polyline or polygon from the map widget to a question in the survey widget.',
  whatsNewStep10Title: 'Data',
  whatsNewStep10Content: 'Provides new data types, including feature collection, and scene layers that support query and feature collection items. Also added support for subscriber content from ArcGIS Online.',
  whatsNewStep11Title: 'Performance',
  whatsNewStep11Content: 'Improved several key areas such as the ability to use more than 16 maps in an Experience, faster loading speeds for widgets, and enhanced app and builder rendering performance.',
  whatsNewStep12Title: 'Template',
  whatsNewStep12Content: 'Adds four new app default and page templates including Dart, Pocket, Quick navigation, and Parallax.',
