define({
  ...
  whatsNewStep2Title: 'Новое: Группа экранов',
  whatsNewStep2Content: 'Обеспечивает новый режим пролистывания, который содержит несколько страниц, занимающих всю высоту экрана. Вы можете пролистывать содержание на панели пролистывания одного экрана, тогда как виджеты остаются в фоновом слое экрана. Тем не менее фон экрана будет меняться при пролистывании панели.',
  whatsNewStep3Title: 'Новое: Виджет таблицы (бета)',
  whatsNewStep3Content: 'Позволяет отображать лист атрибутов из данных в форме таблицы.',
  whatsNewStep4Title: 'Виджет Закладка',
  whatsNewStep4Content: 'Добавляет поддержку для инициализации закладки, когда загружается виджет для стиля закладки по страницам.',
  whatsNewStep5Title: 'Виджет Встроить',
  whatsNewStep5Content: 'Добавить несколько опций, таких как настройки интервала автоматического обновления для встроенных ресурсов и разрешить пользователям доступ к встроенному элементу ArcGIS Online, опубликованному среди организации без дополнительного входа.',
  whatsNewStep6Title: 'Виджет Фильтр',
  whatsNewStep6Content: 'Добавляет предопределенные значения (уникальные и множественные) в конструктор выражений SQL.',
  whatsNewStep7Title: 'Виджет Карта',
  whatsNewStep7Content: 'Добавляет поддержку для изменения цвета подсветки выбранного элемента.',
  whatsNewStep8Title: 'Виджет Раздел',
  whatsNewStep8Content: 'Добавляет поддержку для автовоспроизведения и встраивания навигация, такой как стрелки и точки.',
  whatsNewStep9Title: 'Виджет Опрос',
  whatsNewStep9Content: 'Добавляет поддержку для передачи линии или полигона из виджета карты в вопрос виджета опроса.',
  whatsNewStep10Title: 'Данные',
  whatsNewStep10Content: 'Предоставляет новые типы данных, включая наборы объектов и слои сцены, которые поддерживают запросы и элементы наборов объектов. Также добавляет поддержку для ресурсов подписчиков из ArcGIS Online.',
  whatsNewStep11Title: 'Производительность',
  whatsNewStep11Content: 'Улучшенные несколько ключевых областей, например, использование более 16 карт в Experience, ускоренная загрузка виджетов и улучшенная производительность отображения приложений и конструкторов.',
  whatsNewStep12Title: 'Шаблон',
  whatsNewStep12Content: 'Добавляет четыре новых приложения по умолчанию и шаблоны страниц, включая Dart, Pocket, Quick navigation и Parallax.',
